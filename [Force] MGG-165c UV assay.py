...
shade_color = 'gray'
plt.fill_between((10.5, 20.5),max(ax.get_ylim()),min(ax.get_ylim()), facecolor = shade_color, alpha = 0.2) 
plt.fill_between((30.5, len(time)),max(ax.get_ylim()),min(ax.get_ylim()), facecolor = shade_color, alpha = 0.2) 

ylim = ax.get_ylim()
#text_coord = [(10, max(ylim)*(1/2)),(30, max(ylim)*(1/2))]

text_coord = [(0.36, 0.9),(0.81, 0.9)]

for _ in text_coord:
    plt.annotate("ON", xy=(3, 1), xycoords='axes fraction', xytext=_, fontsize= 18)



at = AnchoredText(
    "Force", prop=dict(size=15), frameon=True, loc='upper left')
at.patch.set_boxstyle("round,pad=0.,rounding_size=0.2")
ax.add_artist(at)

############## MGG-165c: FORCE, vesciles 5%

# file_path_UV = force_5
# file_path_UV_lac = force_5_lac
# plt.legend(['AT 5 (2-H)','DT 5 (3-H)','H 5','Lac(+) control','Lac(-) control'],bbox_to_anchor=(1.05, 1.02),,loc='upper right', bbox_to_anchor=(1.35, 1.02))

#plt.legend(['AT (2-H)','DT (3-H)','H','Lac(+) control','Lac(-) control'],loc='upper right', bbox_to_anchor=(1.35, 1.02))

force_5 = [
'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-1 AT5   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-2 DT5   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-3 H5   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-7 Lacc+AR   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-8 ARonly  Force_wAR_t0-to-40min.csv'
 ]
force_5_lac = [
'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-1 AT5   _100ulin200ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-2 DT5   _100ulin200ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-3 H5   _100ulin200ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-7 Lac2mgml   _15ulin285ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-8 AR 1mgml only  _7p5ulin300ul.csv'
 ]

############## MGG-165c: FORCE, vesciles 95%

#file_path_UV = force_95
#file_path_UV_lac = force_95_lac
#plt.legend(['AT 95 (2-H)','DT 95 (3-H)','H 95','Lac(+) control','Lac(-) control'],loc='upper right', bbox_to_anchor=(1.35, 1.02))

force_95 = [
'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-4 AT 95   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-5 DT 95   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-6 H 95   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-7 Lacc+AR   Force_wAR_t0-to-40min.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-8 ARonly  Force_wAR_t0-to-40min.csv'
 ]

force_95_lac = [
'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-4 AT 95   _100ulin200ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-5 DT 95   _100ulin200ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-6 H 95   _100ulin200ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-7 Lac2mgml   _15ulin285ul.csv',
 'C:\\Users\\drb18182\\Desktop\\Docs\\Data\\uv-vis\\MGG-165 [GPSomes, 5% & 95%, TF, LAc nanoreactors]\\[MGG-165c] [UV] assay_FORCE\\[UV] MGG-165c-8 AR 1mgml only  _7p5ulin300ul.csv'
 ]